...
<body>
	...
	<div id="contents">
		...
		<table>
			...
			<!-- 리스트 반복 시작 -->
			<!--varStatue란 무엇인가? var의 상태를 의미하는 여러 속성들의 집합? -->
			<!--${status.index}란? 0부터 시작했을 때, var가 몇 번 째 index인지를 나타낸다. -->
			<c:forEach items="${viewData.memberList}" var="memberInfo" varStatus="stat">
				<tr>
					...
					<td>	
				<a href="updateFormManager?memberId=${memberInfo.idx}">수정</a> 
...
<script>
	function delMember(idx) {
		...
		if(confirm("삭제하시겠습니까?")){
			location.href = 'memberDelete/'+idx;
		}
